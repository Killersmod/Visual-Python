"""
Add node model for addition operations in VisualPython.

This module defines the AddNode class, which performs addition of two numeric values.
"""
...
class AddNode(BaseNode):
    """
    A node that adds two numeric values together.

    The AddNode provides a visual way to perform addition without writing code.
    It accepts two numeric inputs and outputs their sum.
    ...
    node_type: str = "add"
    """Unique identifier for add nodes."""
    ...
    def __init__(
        ...
        """
        Initialize a new AddNode instance.

        Args:
            node_id: Optional unique identifier. If not provided, a UUID will be generated.
            name: Optional display name. If not provided, defaults to 'Add'.
    ...
    def _setup_ports(self) -> None:
        """
        Set up the input and output ports for the add node.
    ...
    def _get_serializable_properties(self) -> Dict[str, Any]:
        """
        Get add node specific properties for serialization.
    ...
    def _load_serializable_properties(self, properties: Dict[str, Any]) -> None:
        """
        Load add node specific properties from serialized data.
    ...
    def __repr__(self) -> str:
        """Get a detailed string representation of the add node."""
        return (
